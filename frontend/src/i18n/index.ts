...
const resources = {
  en: {
    translation: {
      appTitle: "MediCheck",
      subtitle: "Drug interaction and safety analysis for 2-5 medications",
      ...
      back: "Back",
      requiredHint: "Provide 2 to 5 medications.",
  ...
  de: {
    translation: {
      appTitle: "MediCheck",
      subtitle: "Arzneimittel-Interaktions- und Sicherheitsanalyse fur 2-5 Medikamente",
      ...
      back: "Zuruck",
      requiredHint: "Bitte 2 bis 5 Medikamente angeben.",
